...
export default object = {
    ...
    record: [ /// 版本更新记录 描述 只起记录作用
        ...
        // { version: '0.3.7.0 test', ver: '0.3.7.0 测试环境，设备重启后仍然能恢复上一刻的巡检进度' },
        // { version: '0.3.7.0', ver: '0.3.7.0 正式环境，设备重启后仍然能恢复上一刻的巡检进度' },
        // { version: '0.3.7.1', ver: '0.3.7.1 正式环境，添加操作日志' },
        { version: '0.3.7.2', ver: '0.3.7.2 正式环境，设备状态历史记录倒序排列' },
    ]
};
